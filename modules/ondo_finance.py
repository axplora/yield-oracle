...
def ondo_finance():
    ...
    driver.get('https://ondo.finance/usdy')
    ...
    rate = blended_soup.xpath('//*[@id="__next"]/div[2]/main/div[1]/div/div/div/div[3]/div[2]/h4')[0].text
    float_rate = float(rate.strip("%"))
    rounded_rate = round(float_rate,2)

    cursor.execute("INSERT INTO defi_yield (yield_id, rate) VALUES (%s, %s)", (104, rounded_rate))
    conn.commit()
